...
const OPEN_REPOSITORY_COMMAND_ID = 'reea.copilot.chat.cloudSessions.openRepository';
const CLEAR_CACHES_COMMAND_ID = 'reea.copilot.chat.cloudSessions.clearCaches';
...
export class CopilotCloudSessionsProvider extends Disposable implements vscode.ChatSessionContentProvider, vscode.ChatSessionItemProvider {
	...
	private registerCommands() {
		...
		this._register(vscode.commands.registerCommand('reea.copilot.chat.checkoutPullRequestReroute', checkoutPullRequestReroute));
		...
		this._register(vscode.commands.registerCommand('reea.copilot.chat.openPullRequestReroute', openPullRequestReroute));
	...
	async provideChatSessionItems(token: vscode.CancellationToken): Promise<vscode.ChatSessionItem[]> {
		...
		this.chatSessionItemsPromise = (async () => {
			...
			vscode.commands.executeCommand('setContext', 'reea.copilot.chat.cloudSessionsEmpty', filteredSessions.length === 0);
	...
	async delegate(
		...
		return {
			...
			command: {
				...
				command: 'reea.copilot.chat.openPullRequestReroute',
