...
const NOTEBOOK_FOLLOW_IN_SESSION_KEY = 'reea.copilot.notebookFollowInSessionEnabled';
...
export class NotebookFollowCommands extends Disposable {
	...
	constructor(
		...
		this._register(vscode.commands.registerCommand('reea.copilot.chat.notebook.enableFollowCellExecution', () => {
			this.updateFollowContext(true);
		}));

		this._register(vscode.commands.registerCommand('reea.copilot.chat.notebook.disableFollowCellExecution', () => {
