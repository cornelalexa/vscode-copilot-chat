...
export const buildRemoteIndexCommandId = 'reea.copilot.buildRemoteWorkspaceIndex';
export const deleteExternalIngestWorkspaceIndexCommandId = 'reea.copilot.deleteExternalIngestWorkspaceIndex';
...
export function register(accessor: ServicesAccessor): IDisposable {
	...
	disposableStore.add(vscode.commands.registerCommand('reea.copilot.debug.collectWorkspaceIndexDiagnostics', async () => {
