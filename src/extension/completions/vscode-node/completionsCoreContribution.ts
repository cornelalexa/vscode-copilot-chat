...
export class CompletionsCoreContribution extends Disposable {
	...
	constructor(
		...
		this._register(autorun(reader => {
			...
			void commands.executeCommand('setContext', 'reea.copilot.extensionUnification.activated', extensionUnification);
		...
		this._register(autorun(reader => {
			...
			void commands.executeCommand('setContext', 'reea.copilot.activated', token !== undefined);
		}));
	}
}
