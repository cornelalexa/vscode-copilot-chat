...
describe('NESProvider Facade', () => {
	it('should handle getNextEdit call with a document URI', async () => {
		...
		nextEditProvider.updateTreatmentVariables({
			'config.reea.copilot.chat.advanced.inlineEdits.xtabProvider.defaultModelConfigurationString': '{ "modelName": "xtab-test", "promptingStrategy": "copilotNesXtab", "includeTagsInCurrentFile": false }',
		});
